...
const Navbar = () => {
  ...
  return (
    <div className='w-full flex justify-between items-center p-4 sm:py-6 sm:px-24 absolute top-0'>
        ...
        : 
        <button onClick={()=>navigate('/login')} className='flex items-center gap-2 border border-gray-500 px-6 py-2 rounded-full cursor-pointer text-gray-800 hover:bg-gray-100 transition-all'>Login <img src={assets.arrow_icon} alt="" /></button>
